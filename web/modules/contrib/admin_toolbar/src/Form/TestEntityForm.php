  ...
  public function save(array $form, FormStateInterface $form_state): int {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('admin_toolbar')->notice('New test entity %label has been created.', $logger_args);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The test entity %label has been updated.', $message_args));
        $this->logger('admin_toolbar')->notice('The test entity %label has been updated.', $logger_args);
        break;
